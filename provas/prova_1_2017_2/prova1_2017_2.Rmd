...
&= \frac{(\alpha^{\ast} + 1)\Gamma(\alpha^{\ast})}{\Gamma(\alpha^{\ast})}  \frac{\beta^{\ast\alpha^{\ast}}}{\beta^{\prime\alpha^{\prime}}} \\
&= \frac{(\alpha^{\ast} + 1)\Gamma(\alpha^{\ast})}{\Gamma(\alpha^{\ast})}  \frac{\beta^{\ast\alpha^{\ast}}}{\beta^{\prime\alpha^{\prime}}} \\
&= \frac{\Gamma(\alpha^{\prime})}{\Gamma(\alpha^{\ast})}  \frac{\beta^{\ast\alpha^{\ast}}}{\beta^{\prime\alpha^{\prime}}} \varpropto \frac{1}{\beta^{\prime\alpha^{\prime}}} \\
\end{align}
$$
